...
@"../grb_linked_install_scripts/summarize_install_log.sql" "grbtctx" "" ""
...
@"../grb_linked_install_scripts/list_invalids.sql" "'ODBCTEST'" "" ""
spool off
set termout on
set feedback on
...
@"../grb_linked_install_scripts/db_build_junit_report.sql" "'ODBCTEST'" "" ""
spool off
set termout on
set feedback on
...
@"../grb_linked_install_scripts/log_files_junit_report.sql" "grbtctx" "" ""
spool off
set termout on
set feedback on
