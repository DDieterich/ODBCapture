...
PDB_ODBCTEST="ODBCTEST/13${USR_PASS}@OnPrem_Free234_${PDB_NAME}"
PDB_ODBCAPTURE="ODBCAPTURE/67${USR_PASS}@OnPrem_Free234_${PDB_NAME}"
...
capture_version
build_init
for BTYPE in 'grbsrc' 'grbras' 'grbjava' 'grbsdo' 'grbxrep' 'grbdat' 'grbtst' 'grbtjva' 'grbtjsn' 'grbtsdo' 'grbtctx' 'grbtdat'
do
