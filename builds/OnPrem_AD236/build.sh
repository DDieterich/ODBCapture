...
PDB_NAME='MYATP'
###
PDB_SYS="ADMIN/${SYS_PASS}@OnPrem_AD236_${PDB_NAME}"
SYS_LOGIN="${PDB_SYS}"
PDB_SYSTEM="${PDB_SYS}"
PDB_ODBCTEST="ODBCTEST/13${USR_PASS}@OnPrem_AD236_${PDB_NAME}"
PDB_ODBCAPTURE="ODBCAPTURE/67${USR_PASS}@OnPrem_AD236_${PDB_NAME}"
