...
@"../grb_linked_install_scripts/summarize_install_log.sql" "grbtst" "" ""
...
@"../grb_linked_install_scripts/list_invalids.sql" "'ODBCAPTURE','ODBCTEST'" "" ""
spool off
set termout on
set feedback on
...
@"../grb_linked_install_scripts/db_build_junit_report.sql" "'ODBCAPTURE','ODBCTEST'" "" ""
spool off
set termout on
set feedback on
...
@"../grb_linked_install_scripts/log_files_junit_report.sql" "grbtst" "" ""
spool off
set termout on
set feedback on
